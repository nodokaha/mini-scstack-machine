...
(define (command op)
  (cond
   ...
   ((or (eq? op 'draw-line) (eq? op 'dl))   (sdl2:set-render-draw-color! render 0 0 0 0) (sdl2:render-draw-line! render 0 0 100 100) (sdl2:render-present! render) (sdl2:set-render-draw-color! render 255 255 255 0))
;   ((or (eq? op 'set-color) (eq? op 'sc)) (sdl2:fill-rect! surface #f (sdl2:map-rgb (sdl2:surface-format surface) 0 128 255)))
   ((or (eq? op 'refresh-window) (eq? op 'rw)) #| (sdl2:update-window-surface! window) |# (sdl2:render-present! render))
